...
- [Phase 2.5: 도커화 & 서버 배포](#phase-25-도커화--서버-배포-) 🐳
...
**봇 시스템 (economy_bot):**
- [Phase 9: 봇 핵심 - 재화 지급 & 출석](#phase-9-봇-핵심---재화-지급--출석)
- [Phase 10: 봇 명령어 - 휴식 & 일정 조회](#phase-10-봇-명령어---휴식--일정-조회)
- [Phase 11: 봇 통합 - 예약 발송 & 스케줄러](#phase-11-봇-통합---예약-발송--스케줄러)
