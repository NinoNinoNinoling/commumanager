...
4. 구매 성공
   ...
   ↓ NO (재화 부족 or 아이템 없음)
5. 구매 실패
   a. 멘션에 별표 누르지 않음 (or 다른 이모지)
   b. DM 발송
      "❌ 재화가 부족합니다! (필요: 100원 / 보유: 80원)"
      or "❌ 해당 아이템이 없습니다!"
```

**장점**:
- 타임라인에서 별표로 구매 내역 한눈에 확인
- 어떤 유저가 언제 뭘 샀는지 시각적으로 명확
- 봇 응답을 기다리지 않고 별표로 즉시 피드백
...
4. 명령어별 분기
   ...
   ├→ 해당 멘션에 별표(⭐) 누름
   └→ 양측에 DM 발송
      발신자: "✅ @user2님께 금테두리 양도 완료"
      수신자: "🎁 @user1님께서 금테두리를 보냈습니다!"
