...
gantt
    ...
    section Phase 0
    사전 준비           :p0, 2024-11-17, 2d
    section Phase 1
    서버 구축           :p1, after p0, 2d
    section Phase 2
    최소 웹 구현        :p2, after p1, 2d
    section Phase 3
    재화 지급 봇        :p3, after p2, 3d
    section Phase 4
    활동량 체크 봇      :p4, after p3, 3d
    section Phase 5
    상점 시스템         :p5, after p4, 2d
    section Phase 6
    관리자 웹 완성      :p6, after p5, 5d
    section Phase 7
    테스트 및 최적화    :p7, after p6, 4d
```

**총 예상 소요**: 16~23일 (11월 내 완료 목표)
**병행 개발**: Phase 2 이후 봇/웹 동시 개발 가능
...
## Phase 6: 관리자 웹 완성 (4~5일)

### 작업 (일자별)
1. 홈 대시보드 완성 (통계 차트)
2. 활동량 관리 (경고 내역, 휴식 관리)
3. 재화 관리 (트랜잭션 내역)
4. 상점 관리 (아이템 CRUD)
5. 콘텐츠 관리 (스토리/공지)
6. 시스템 설정 + 로그
...
| 11월 내 완료 지연 | 중 | 핵심 기능 우선, 선택 기능 연기 |
