...
### 인프라 구성
- [ ] 테스트 서버 배포 (DuckDNS 사용)
  - [ ] testmast.duckdns.org (테스트 마스토돈 서버)
  - [ ] testadmin.duckdns.org (테스트 관리자 웹)
- [ ] 본 서버 배포
  - [ ] your-mastodon.duckdns.org (프로덕션 마스토돈)
  - [ ] your-admin.duckdns.org (프로덕션 관리자 웹)
