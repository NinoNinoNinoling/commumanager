...
💡 **UI 참고**: [수동 경고 발송 모달 화면](SCREEN_EXAMPLES.md#5-1-수동-경고-발송-모달)
...
관리자 웹 인터페이스의 상세한 화면 디자인과 UI 목업은 별도 문서를 참조하세요.

📖 **[화면 예시 및 디자인 가이드 보기 →](SCREEN_EXAMPLES.md)**

**포함 내용:**
- 11개 화면 SVG 목업 (메인 10개 + 수동 경고 모달)
- Bootstrap 5 기반 디자인 시스템
- 반응형 레이아웃 가이드
- 색상 팔레트 및 타이포그래피
- 컴포넌트 사용 예시
- 실제 사용 시나리오 기반
...
**관련 문서:**
- [화면 예시 및 디자인 가이드](SCREEN_EXAMPLES.md) - UI 목업 및 디자인 시스템
