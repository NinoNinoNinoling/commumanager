...
- **⚠️ 활동량 모니터링**: 4가지 관점에서 유저 활동 건강도 분석
...
**사용 예시:**
- 정기 이벤트: "봄맞이 축제", "추석 연휴"
- 커뮤니티 방학: "여름 방학 기간", "겨울 방학"
- 공휴일: "설날", "크리스마스"

### 6.3 학기 vs 방학 기간 이해하기

커뮤니티는 두 가지 상태로 운영됩니다:
...
**방학 기간 설정 방법:**
1. 일정 등록 시 "방학 기간 (전역 휴식)" 체크박스 선택
2. 시작일과 종료일 설정
3. 제목/설명 입력 (예: "여름 방학", "시즌2 준비 기간")

⚠️ **개별 유저 휴식**과 구분:
- 개별 유저 휴식: 특정 유저만 활동량 체크 제외 → [3.2절 참조](#32-휴식-관리-탭-2)
- 방학 기간: 커뮤니티 전체가 휴식 (모든 유저 활동량 체크 제외)
