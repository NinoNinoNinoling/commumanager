...
💡 **사용 시나리오**: 유저가 장기 휴가를 가거나, 개인 사정으로 일정 기간 활동이 불가능할 경우 관리자가 등록합니다.
...
각 유저는 **러닝 기간마다 제한된 휴식 일수**를 사용할 수 있습니다.

**할당량 예시:**
- 설정: 1개월당 3일 휴식 허용
- 유저 A가 11월에 2일 사용 → 남은 휴식: 1일
- 12월 1일 리뉴얼 → 사용량 리셋, 다시 3일 사용 가능
- 11월 사용 기록은 영구 보관 (히스토리)

**설정 방법:**
1. **상단 메뉴 → ⚙️ 설정 → 휴식 정책**
2. 다음 항목 설정:
   - **휴식 할당량**: 러닝 기간당 사용 가능 일수 (예: 3일)
   - **러닝 기간**: 리뉴얼 주기 (예: 1개월)
   - **리뉴얼 기준일**: 리셋 날짜 (예: 매월 1일)

**휴식 현황 표시:**
- 각 유저의 **현재 기간 사용량** 표시 (예: 3일 중 2일 사용)
- 남은 휴식 일수 자동 계산
- 할당량 초과 시 휴식 신청 불가
