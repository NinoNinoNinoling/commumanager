...
admin_log_controller = AdminLogController()
...
def get_user(mastodon_id):
    """유저 상세"""
    return user_controller.get_user(mastodon_id)


@api_bp.route('/users/<mastodon_id>/role', methods=['PATCH'])
def update_user_role(mastodon_id):
    """역할 변경"""
    return user_controller.update_role(mastodon_id)
...
def get_warnings():
    """경고 목록"""
    return warning_controller.get_warnings()


@api_bp.route('/warnings', methods=['POST'])
def create_warning():
    """경고 생성"""
    return warning_controller.create_warning()


@api_bp.route('/users/<mastodon_id>/warnings', methods=['GET'])
def get_user_warnings(mastodon_id):
    """유저별 경고"""
    return warning_controller.get_user_warnings(mastodon_id)
...
def get_vacations():
    """휴가 목록"""
    return vacation_controller.get_vacations()


@api_bp.route('/vacations', methods=['POST'])
def create_vacation():
    """휴가 생성"""
    return vacation_controller.create_vacation()


@api_bp.route('/vacations/<int:vacation_id>', methods=['DELETE'])
def delete_vacation(vacation_id):
    """휴가 삭제"""
    return vacation_controller.delete_vacation(vacation_id)
...
def get_events():
    """이벤트 목록"""
    return calendar_controller.get_events()
...
def update_event(event_id):
    """이벤트 수정"""
    return calendar_controller.update_event(event_id)


@api_bp.route('/calendar/events/<int:event_id>', methods=['DELETE'])
def delete_event(event_id):
    """이벤트 삭제"""
    return calendar_controller.delete_event(event_id)
...
def get_settings():
    """설정 조회"""
    return setting_controller.get_settings()


@api_bp.route('/settings/<key>', methods=['PUT'])
def update_setting(key):
    """설정 업데이트"""
    return setting_controller.update_setting(key)
...
def get_admin_logs():
    """관리자 로그"""
    return admin_log_controller.get_logs()
